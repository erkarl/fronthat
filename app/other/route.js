...
export default Route.extend({
  ...
  setHeadTags: function() {
    const description = 'Curated collection of 100% miscellaneous remote development and desig jobs.';
    var headTags = [
      {
        type: 'meta',
        tagId: 'meta-og-title',
        attrs: {
          name: 'og:title',
          content: 'Remote Miscellaneous Development and Design Jobs',
        }
      },
      {
        type: 'meta',
      ...
      },
      {
        ...
        attrs: {
          name: 'og:url',
          content: 'https://fronthat.com/design'
        }
      },
      {
        type: 'meta',
